(()=> {
  ...
  function card(r) {
    ...
    return `<article class="card">
      ...
      <div class="card-actions">
        ...
        ${s==="saved" ? `<button class="btn primary" data-quote="${esc(r.id)}">Request quote</button>` : ""}
  ...
  function resume(id) {
    ...
    if (!r) return;
    location.href = `builder/?build=${encodeURIComponent(shareValue(r.build_data?.serialized || {}))}`;
  }
